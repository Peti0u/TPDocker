...
from django_dyn_dt.models import ModelFilter, PageItems, HideShowFilter
from django_dyn_dt.utils import user_filter
...
def index(request):
    ...
    return render(request, 'pages/dynamic-dt.html', context)
...
def model_dt(request, aPath):
    ...
    return render(request, 'pages/dynamic-dt-model.html', context)
